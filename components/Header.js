...
<div id="header">
    <div class="container">
        ...
        <p class="me">My name is Nicholas and I have built this site to display my knowlwdge of web-development. I have used the information gathered throughout this course to build a website that accurately describes my knowledge.</p>
            <div id="greeting"></div>
    </div>
</div>
`;
